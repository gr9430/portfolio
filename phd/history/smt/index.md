...
project: true
tags: [Texts and Technology in History, Data Visualization, Network Analysis, History, Collaborative, Texts and Technology, Digital Humanities, Irish Literature, Medieval, Adaptation]
---
...
**Course:** ENG 6801 - Instructor: Dr. Louise Kane, University of Central Florida
**Presented:** High Impact Practices Student Showcase Spring 2026

## Interactive Padlet Presentation

<div class="padlet-embed" style="border:1px solid rgba(0,0,0,0.1);border-radius:2px;box-sizing:border-box;overflow:hidden;position:relative;width:100%;background:#F4F4F4;margin:2rem 0;"><p style="padding:0;margin:0"><iframe src="https://padlet.com/embed/l8zjtbh2hxzqeo71" frameborder="0" allow="camera;microphone;geolocation;display-capture;clipboard-write" style="width:100%;height:608px;display:block;padding:0;margin:0"></iframe></p></div>

**[View the Network Graph](/phd/history/smt/network.html)**
...
**Data Format**: JSON with structured mythology metadata
**Hosting**: GitHub Pages with Jekyll integration
